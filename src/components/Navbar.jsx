...
function Navbar({ theme, setTheme }) {
  return (
    ...
    py-4 sticky top-0 z-20 backdrop:blur-xl font-medium pg-white/50 dark:bg-gray-900/70"
    >
      <img
      ...
      <div
        className="text-gray-700 dark:text-white sm:text-sm max-sm:w-60
       max-sm:pl-10 max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen
        ...
        max-sm:bt-20 flex sm:items-center gap-5 transition-all"
      >
